export const triviaFacts = [
         ...
         "There are 4 separate locations that claim to have the world's largest ball of twine: Johnson’s ball of twine (MN), the Cawker City Ball (KS), The Branson Ball (MO), and The JFK ball (WI).",
         ...
         "The World’s Largest Toilet is located in Columbus, Indiana, and as a bonus it serves as the entrance to a plumbing-themed playground.",
